package com.comorinland.milkman.common.babushkatext;
...
public class BabushkaText extends TextView {
    ...
    private void applySpannablesTo(Piece aPiece, SpannableString finalString, int start, int end) {
        ...
        if (aPiece.isTypeface) {
            finalString.setSpan(new CustomTypefaceSpan(aPiece.typeFace), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
    ...
    public static class Piece {
        ...
        private final boolean isTypeface;
        ...
        public Piece(Builder builder) {
            ...
            this.isTypeface = builder.isTypeface;
        ...
        /**
         * Sets the type face of this piece.
         */
        ...
        public static class Builder {
            ...
            /**
             * Sets the Typeface to this piece
             */
            public Builder typeFace(Typeface tf){
                this.isTypeface = true;
                this.typeface = tf;
                return this;
            }
